/-
📝 附录A：振幅函数的详细证明
文件: Appendices/AppendixA/Amplitude.lean
版本: 10.4.5
日期: 2026-06-17
================================================================================
...
**命名空间**: CSQIT.Appendices.AppendixA.Amplitude
**用途**: 详细证明存储，供引用和验证使用
================================================================================
-/
...
namespace CSQIT.Appendices.AppendixA.Amplitude
...
-/
theorem amplitude_norm_one_detail {M C : Type*} [A : AxiomA M C] [Cx : AxiomC M C]
...
-/
theorem amplitude_ne_zero_detail {M C : Type*} [A : AxiomA M C] [Cx : AxiomC M C]
...
-/
theorem amplitude_compose_detail {M C : Type*} [A : AxiomA M C] [Cx : AxiomC M C]
...
证明策略:
  ...
  3. 应用复数乘法结合律
-/
theorem amplitude_compose_assoc_detail {M C : Type*} [A : AxiomA M C] [Cx : AxiomC M C]
    (α β γ : C) :
...
-/
theorem amplitude_eq_imp_rule_eq_detail {M C : Type*} [A : AxiomA M C] [Cx : AxiomC M C]
...
-/
theorem amplitude_left_cancel_detail {M C : Type*} [A : AxiomA M C] [Cx : AxiomC M C]
    {α β γ : C}
    (h : Cx.amplitude α * Cx.amplitude γ = Cx.amplitude β * Cx.amplitude γ) :
    Cx.amplitude α = Cx.amplitude β := by
  have h_nonzero : Cx.amplitude γ ≠ 0 := amplitude_ne_zero_detail γ
...
end CSQIT.Appendices.AppendixA.Amplitude