...
private lemma fin4_I_inj (x y : Fin 4)
  ...
  -- Fin 4 的值范围为 {0,1,2,3}，使用 fin_cases 穷举
  fin_cases x
  · -- x = 0, 即 x.val = 0, I^0 = 1
    fin_cases y
    · rfl
    · simp [I_pow_0, I_pow_1] at h; contradiction
    · simp [I_pow_0, I_pow_2] at h; contradiction
    · simp [I_pow_0, I_pow_3] at h; contradiction
  · -- x = 1, 即 x.val = 1, I^1 = I
    fin_cases y
    · simp [I_pow_0, I_pow_1] at h; contradiction
    · rfl
    · simp [I_pow_1, I_pow_2] at h; contradiction
    · simp [I_pow_1, I_pow_3] at h; contradiction
  · -- x = 2, 即 x.val = 2, I^2 = -1
    fin_cases y
    · simp [I_pow_0, I_pow_2] at h; contradiction
    · simp [I_pow_1, I_pow_2] at h; contradiction
    · rfl
    · simp [I_pow_2, I_pow_3] at h; contradiction
  · -- x = 3, 即 x.val = 3, I^3 = -I
    fin_cases y
    · simp [I_pow_0, I_pow_3] at h; contradiction
    · simp [I_pow_1, I_pow_3] at h; contradiction
