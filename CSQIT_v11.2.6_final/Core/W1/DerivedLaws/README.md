...
|------|------|---------|---------|---------|------|
| 最小作用量原理（离散版） | 🟡 W2 框架 | 从变分原理导出，需要离散微积分工具 | 离散变分的定义 | `ClassicalMechanics/LeastAction.lean` | ✅ 已完成（框架） |
| 热力学第一定律（能量守恒+热功当量） | 🟢 W2 条件 | 能量守恒 + 因果熵与能量的关系 | 熵-能量对应关系 | `Thermodynamics/FirstLaw.lean` | ✅ 已完成（条件性） |
