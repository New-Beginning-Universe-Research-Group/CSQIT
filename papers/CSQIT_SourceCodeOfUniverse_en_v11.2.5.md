...
Three epistemic levels are strictly distinguished: W1 (formalized mathematics), W2 (effective theory/numerical), and W3 (physical interpretation). All cross-level assertions are explicitly labeled.
...
**Unsatisfiability under the Total-Subset Principle** (W1 layer, new in v11.2.5):
...
**Phase 4: W2 Offensive G1–G5 (v11.2.5)**

v11.2.5 completed the key strictification work of the W2-layer offensive:
...
**Current Status (v11.2.5)**

| Category | Count |
|:---|:---:|
| Sorry eliminated since v11.0 | **13 + 0 new in v11.2.5** (v11.2.5 strictifications are all new proofs, not elimination of existing sorry) |
...
**Note**: v11.2.5 has 63 compiled Lean modules (included in the main build), approximately 39,000 lines of formalized code. `DerivedLaws/` and `Appendices/` are not included in the main build (see §9.5 for details).
...
**Note (v11.2.5)**: At the observational anchoring level, $\Omega_m = \theta$ is a physical correspondence postulate (W2/W3), not a mathematical theorem (see §5.5). The Total-Subset Principle predicts that $\Omega_m^{\text{obs}}$ is a rational approximant of $\theta$, not the exact value; the relative deviation of about 0.97% is a structural prediction (see §5.9).
...
*CSQIT v11.2.5 — Formalized deduction from information-theoretic axioms to the cosmological characteristic constant*
